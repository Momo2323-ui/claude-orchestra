...
- **2026-05-26 (v3 polish-pass)** — Drained the remaining P1/P2 items from this plan into the v3 atomic-release stage (NOT pushed — soak still gates v3.0.0). **Shipped today (in `~/Projects/claude-orchestra/`, awaiting v3 atomic commit):** `ROADMAP.md` (P0#5), `CONTRIBUTING.md` v2 (P1#6), `.github/pull_request_template.md` + `bug_report.md` + `feature_request.md` (P1#7), `examples/01-real-prompts.md` (P1#8), `assets/asciinema-script.md` (P1#9 — recording still Moksh's to do), `UNINSTALL.md` (P1#10), `docs/TROUBLESHOOTING.md` skeleton (P2#11), `CODEOWNERS` (P2#12), `.github/dependabot.yml` (P2#13). **Tag v1.0 release (P2#14) deferred** — superseded by the v3.0.0 atomic-release plan (see `HANDOFF.md` and `ROADMAP.md`). **Still open:** P1#11 visible roster in README, P1#12 before/after value-prop block, P1#13 one-line curl installer (all carried into the v3 README rewrite during Phase 3 / pre-launch). Also **cross-skill AUDIT** ran clean across all 7 Phase 1.3-1.9 skills (READY verdict in `~/.claude/docs/learnings/audit-log.md`).
