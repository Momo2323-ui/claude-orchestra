...
## Appendix — the raw engine output

The announcements above are what you read. Underneath, the score engine injects a routing
block like this into Claude's context (live `orchestra route` output, not a mock):
